export const getCaretIndex = (el: Node) => {
  let position = 0;
...
export const getSelection = (el: Node) => {
  const range = window.getSelection()!.getRangeAt(0);
...
export const updateCaret = (el: HTMLDivElement, caret: number, offset: number) => {
...
export const insertNodeAtCaret = (el: any) => {
