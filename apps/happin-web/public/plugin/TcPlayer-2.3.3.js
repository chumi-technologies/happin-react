! function(e, t) {
	...
	return function(e) {
		...
		for (var m = i(2), w = o(m), b = i(4), M = o(b), S = i(1), I = o(S), E = 1, _ = t.FullscreenApi = {
			...
			], D = T[0], L = void 0, O = 0; O < T.length; O++)
			if (T[O][1] in document) {
				L = T[O];
				break
			} if (L)
			for (var C = 0; C < L.length; C++) _[D[C]] = L[C];
		t.CDNPath = "https://cloudcache.tencent-cloud.com/open/qcloud/video/vcplayer/", t.VideoType = {
			RTMP: "rtmp",
			FLV: "flv",
			M3U8: "m3u8"
		}, t.console = {
		...
		var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
			...
			b = function(e) {
				...
				return l(t, e), t.prototype.render = function(t) {
					...
					this.flv && (this.flv.unload(), this.flv.detachMediaElement()), this.hls && (this.hls.stopLoad(), this.hls.detachMedia(), this.hls.destroy());
					...
					if (n) switch (i) {
						case Hls.ErrorTypes.NETWORK_ERROR:
							o.indexOf("TimeOut") > 0 ? f.console.error("åŠ è½½è§†é¢‘æ–‡ä»¶è¶…æ—¶") : f.console.error("æ— æ³•åŠ è½½è§†é¢‘æ–‡ä»¶ï¼Œè¯·æ£€æŸ¥ç½‘ç»œï¼Œä»¥åŠè§†é¢‘æ–‡ä»¶æ˜¯å¦å…è®¸è·¨åŸŸè¯·æ±‚è®¿é—®ï¼Œm3u8æ–‡ä»¶æ˜¯å¦å­˜åœ¨ " + (t.response && t.response.status ? "netstatus:" + t.response.status : "")), this.notify({
								type: "error",
								code: 2,
								timeStamp: +new Date
							}), r.startLoad();
					...
					this.hls && (this.hls.stopLoad(), this.hls.detachMedia()), this.flv && (this.flv.detachMediaElement(), this.flv.destroy());
					...
					var i = e.indexOf(".m3u8") > -1 || t == f.VideoType.M3U8,
						o = e.indexOf(".flv") > -1;
					if (!m.IS_ENABLED_MSE || !i && !o || m.IS_X5TBS && this.player.options.x5_player || i && m.IS_MAC && m.IS_SAFARI && !m.IS_IOS) this.hls && (this.hls.stopLoad(), this.hls.detachMedia()), this.flv && (this.flv.unload(), this.flv.detachMediaElement()), this.__type = t, this.el.src = e;
					else {
						var n = this,
			...
			w = function(e) {
				...
				return l(t, e), t.prototype.render = function(e) {
							...
							case "ready":
								if (this.el = a(this.__id), this.setup(), m.IS_FIREFOX) {
									...
									try {
										...
										console.warn("Flash è°ƒç”¨å¤±è´¥ï¼Œè¯·æ£€æŸ¥Flashæ˜¯å¦å¯ç”¨æˆåŠŸ")
									}
					...
					if (this.metaDataLoaded)
						if (this.playState == v.PlayStates.PAUSED) this.el.playerResume();
