          ...
          <>
            {!urlSubmitting ?
              <div className="event-submit__container">
                <h1 className="black-title text-xl sm:text-3xl md:text-4xl text-white font-bold lg:pr-10 mt-1 sm:mt-4">Submit event</h1>
                <h1 className="black-title text-base sm:text-xl text-white mt-1 sm:mt-3">How it works? Find your event landing page.
                ...
                <div className="flex items-center justify-center" style={{ margin: 'auto' }}>
                  <div className="event-submit__inner mt-20">
                    ...
                    <input type="text"
                      ...
                      className="block w-full px-3 py-2 sm:py-3 border-2 border-solid border-gray-600 rounded-lg bg-gray-900 text-white text-center transition placeholder-gray-400 hover:border-gray-500 focus:bg-black"
              ...
              <div className="event-submit__container h-full flex items-center justify-center">
                <div className="flex items-center justify-center " style={{ margin: 'auto', flexDirection: 'column' }}>
                  ...
                  <h1 className="black-title text-base sm:text-xl text-white mt-1 sm:mt-3 font-bold">We are processing the event</h1>
                </div>
              </div>
            }
          </>
