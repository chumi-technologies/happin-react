                      ...
                      <div className="ml-3 flex-1">
                        ...
                        <div className="flex items-start sm:items-center flex-col sm:flex-row text-gray-400">
                          <div className="flex-1 mr-2 text-sm mb-2 sm:mb-0">
                            ...
                            (${moment.duration(moment(eventDetails?.event?.end_datetime).diff(moment(eventDetails?.event?.start_datetime))).asHours()} hours)`}
                          </div>
                        </div>
                      </div>
                    </div>
                                      ...
                                      t.ticketType==='PFM' && t.checked && (
                                          <div className="sm:font-semibold text-gray-500 sm:text-gray-700 mb-3 text-sm">
                                            <div className="text-sm mt-4">
                                              <>This event includes <a rel="noreferrer" href="https://help.happin.app/en/articles/4891884-what-is-vip-fan-meeting" target="_blank" className="link-black">VIP/Fan meeting</a>
